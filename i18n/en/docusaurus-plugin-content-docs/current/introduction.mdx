...
2. [Scripting Engine](/docs/architecture/script_engine_overview) to learn how apps and watch faces run.
...
5. For implementation details of core modules, consult [Core Modules](./architecture/framework/app).
