...
Kernel build options (memory allocation strategy, filesystem type, font source, etc.) are configurable via the Kconfig system. Refer to [Kernel Configuration System](../development/kconfig).
